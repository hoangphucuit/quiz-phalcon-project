<section class="content">
    <div class="" style="padding: 10px;">
        ...
        <form method="get" class="form-horizontal" action="test">
            <!-- Form search start -->
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group col-md-6">
                        <label for="" class="col-md-4 control-label">Mã đề thi:</label>
                        <div class="col-md-8">
            ...
            <div class="btn-group">
                <a href="/dethi/maketest" title="Tạo" class="btn btn-success"><i class="fa fa-plus"></i></a>
                ...
                <div class="box box-danger">
                            ...
                            {% set i = 0 %}
                                <?php foreach ($page->items as $item): ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td> <a href="/test/detail/{{item.id}}" class="btn btn-warning btn-xs info-item"  title="Chi tiết">Chi tiết đề thi</a></td>
                                        <td> <a href="/test/delete/{{item.id}}" class="fa fa-trash btn btn-danger btn-sm delete-item-table" title="Xóa"></a></td>
                    ...
                    <div class="box box-footer">
                        ...
                        <div class="col-sm-11">
                            <nav>
                                <ul class="pagination">
                                    <li><?php echo $this->tag->linkTo("test", "First") ?></li>
                                    <li><?php echo $this->tag->linkTo("test?page=" . $page->before, "Previous") ?></li>
                                    <li><?php echo $this->tag->linkTo("test?page=" . $page->next, "Next") ?></li>
                                    <li><?php echo $this->tag->linkTo("test?page=" . $page->last, "Last") ?></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
