...
<div class="" style="padding: 10px;">
   ...
   <form method="post" action="dethi/mark">
	...
	<div class="TieuDe">
		<h3 >Đề thi trắc nghiệm ngẫu nhiên</h3>
	</div>
	<script>
...
<button type="submit" class="btn btn-success" id="btn_test" name="btn_submit">Success</button>
</ol>
