<section class="content">
    <div class="" style="padding: 10px;">
        ...
        <form method="get" class="form-horizontal" action="schedule">
            <!-- Form search start -->
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group col-md-6">
                        <label for="" class="col-md-4 control-label">Nội dung:</label>
                        <div class="col-md-8">
                            {{form.render('name', ['class':'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="" class="col-md-4 control-label">Mã lịch thi:</label>
            ...
            <div class="btn-group">
                <a href="/schedule/add" title="Tạo" class="btn btn-success"><i class="fa fa-plus"></i></a>
                ...
                <div class="box box-danger">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tên lịch thi(mô tả)</th>
                                    <th>Thời gian bắt đầu</th>
                                    <th>Thời lượng ca thi(phút)</th>
                                    <th>Loại chứng chỉ</th>
                                    <th>Tổng số câu hỏi </th>
                                    <th>Số câu hỏi module 01</th>
                                    <th>Số câu hỏi module 02</th>
                                    <th>Số câu hỏi module 03</th>
                                    <th>Số câu hỏi module 04</th>
                                    <th>Số câu hỏi module 05</th>
                                    <th>Số câu hỏi module 06</th>
                                    <th>Số câu hỏi module 07</th>
                                    <th>Số câu hỏi module 08</th>
                                    <th>Số câu hỏi module 09</th>
                            ...
                            {% set i = 0 %}
                                <?php foreach ($page->items as $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $item->cer_name ?></td>
                                        <td><?php echo $item->numquestion ?></td>
                                        <td><?php echo $item->nummodule1 ?></td>
                                        <td><?php echo $item->nummodule2 ?></td>
                                        <td><?php echo $item->nummodule3 ?></td>
                                        <td><?php echo $item->nummodule4 ?></td>
                                        <td><?php echo $item->nummodule5 ?></td>
                                        <td><?php echo $item->nummodule6 ?></td>
                                        <td><?php echo $item->nummodule7 ?></td>
                                        <td><?php echo $item->nummodule8 ?></td>
                                        <td><?php echo $item->nummodule9 ?></td>
                                        ...
                                        <td> <a href="/schedule/edit/{{item.id}}" class="btn btn-warning btn-xs info-item"  title="Chỉnh Sửa">Chỉnh Sửa thời gian ca thi</a></td>
                                        <td> <a href="/schedule/delete/{{item.id}}" class="fa fa-trash btn btn-danger btn-sm delete-item-table" title="Xóa"></a></td>
                    ...
                    <div class="box box-footer">
                        ...
                        <div class="col-sm-11">
                            <nav>
                                <ul class="pagination">
                                    <li><?php echo $this->tag->linkTo("schedule", "First") ?></li>
                                    <li><?php echo $this->tag->linkTo("schedule?page=" . $page->before, "Previous") ?></li>
                                    <li><?php echo $this->tag->linkTo("schedule?page=" . $page->next, "Next") ?></li>
                                    <li><?php echo $this->tag->linkTo("schedule?page=" . $page->last, "Last") ?></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
