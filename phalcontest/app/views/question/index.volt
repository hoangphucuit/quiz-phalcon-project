<section class="content">
    <div class="" style="padding: 10px;">
        ...
        <form method="get" class="form-horizontal" action="question">
            <!-- Form search start -->
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="col-md-4 control-label">Mã câu hỏi:</label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="" class="col-md-4 control-label">Mã module:</label>

                        <div class="col-md-8">
                            {{form.render('module', ['class':'form-control'])}}
                        </div>
                    </div>
            ...
            <div class="btn-group">
                <a href="/question/add" title="Tạo" class="btn btn-success"><i class="fa fa-plus"></i></a>
                ...
                <div class="box box-danger">
                            ...
                            {% set i = 0 %}
                                <?php foreach ($page->items as $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $item->kindname ?></td>
                                        <td><?php echo $item->answer1 ?></td>
                                        <td><?php echo $item->answer2 ?></td>
                                        <td><?php echo $item->answer3 ?></td>
                                        <td><?php echo $item->answer4 ?></td>
                                        ...
                                        <td></td>
                                        <td><a href="/question/edit/{{item.id}}" class="fa fa-edit btn btn-primary btn-sm" title="Sửa"></a> <a href="/question/delete/{{item.id}}" class="fa fa-trash btn btn-danger btn-sm delete-item-table" title="Xóa"></a></td>
                    ...
                    <div class="box box-footer">
                        ...
                        <div class="col-sm-11">
                            <nav>
                                <ul class="pagination">
                                    <li><?php echo $this->tag->linkTo("question", "First") ?></li>
                                    <li><?php echo $this->tag->linkTo("question?page=" . $page->before, "Previous") ?></li>
                                    <li><?php echo $this->tag->linkTo("question?page=" . $page->next, "Next") ?></li>
                                    <li><?php echo $this->tag->linkTo("question?page=" . $page->last, "Last") ?></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
