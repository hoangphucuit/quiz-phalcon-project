<section class="content">
    ...
    <div class="" style="padding: 10px;">
        ...
        <form method="get" class="form-horizontal">
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group col-md-6">
                        <label for="" class="col-md-4 control-label">Tên module:</label>
                        <div class="col-md-8">
            ...
            <div class="btn-group">
                <a href="/module/add" title="Tạo" class="btn btn-success"><i class="fa fa-plus"></i></a>
                ...
                <div class="box box-danger">
                            ...
                            <tbody>
                                <?php foreach ($page->items as $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $item->type_cer ?></td>
                                        <td><a href="/module/edit/<?= $item->code ?>" class="fa fa-edit btn btn-primary btn-sm" title="Sửa"></a> <a href="/module/delete/<?= $item->code ?>" class="fa fa-trash btn btn-danger btn-sm delete-item-table" title="Xóa"></a></td>
                    ...
                    <div class="box box-footer">
                        ...
                        <div class="col-sm-11">
                            <nav>
                                <ul class="pagination">
                                    <li><?php echo $this->tag->linkTo("module", "First") ?></li>
                                    <li><?php echo $this->tag->linkTo("module?page=" . $page->before, "Previous") ?></li>
                                    <li><?php echo $this->tag->linkTo("module?page=" . $page->next, "Next") ?></li>
                                    <li><?php echo $this->tag->linkTo("module?page=" . $page->last, "Last") ?></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
