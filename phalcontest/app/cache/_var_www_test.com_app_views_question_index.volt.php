                            ...
                            <?php $i = 0; ?>
                                <?php foreach ($page->items as $item): ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><a href="/question/edit/<?= $item->code ?>" class="fa fa-edit btn btn-primary btn-sm" title="Sửa"></a> <a href="/question/delete/<?= $item->id ?>" class="fa fa-trash btn btn-danger btn-sm delete-item-table" title="Xóa"></a></td>
    ...
    <div id="modal_del" class="modal modal-danger fade" role="dialog">
      <div class="modal-dialog modal-sm">
        ...
        <div class="modal-body">
            <p>Bạn muốn xóa người sử dụng?</p>
        </div>
